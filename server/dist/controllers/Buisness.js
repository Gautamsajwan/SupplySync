...
const getManufacturerHandler = async (req, res) => {
    try {
...
const addProductHandler = async (req, res) => {
    try {
        const { prodName, quantity, expDate, temperature, humidity, shock, pressure, } = req.body;
...
//# sourceMappingURL=Buisness.js.map